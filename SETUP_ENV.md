...
- Select your "JobSyncd" integration
...
5. **If you see "Google hasn't verified this app":**
   - Click **Advanced**
   - Click **Go to JobSyncd (unsafe)** ← This is YOUR app, it's safe
...
- ✅ Completed the main JobSyncd setup (Gmail, OpenRouter, Notion)
...
- Open database → Click `...` → Add connections → Select JobSyncd
